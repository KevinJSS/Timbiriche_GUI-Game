...
public class BaseComputer {
     ...
     * quadrant and line position are available.
     *
     * @param board the board to analize
     * @return the position where to add the line, with the quadrant number and
     * then the line position
     */
    ...
    /**
     * This method updates the state of the board to the computer so it can make
     * a propper move choice considering past moves
     *
     * @param board the board to analize
     */
    ...
    /**
     * Method to remove a certain number position from the board positions
     * recognized, so it's not used again
     *
    ...
    /**
     * Method to remove a certain line position from the line positions
     * recognized, so it's not used again
     *
    ...
    /**
     * Method change certain line position, by getting rid of one and moving the
     * others in the vector
     *
    ...
    /**
     * Method change certain quadrant position, by getting rid of one and moving
     * the others in the vector
     *
